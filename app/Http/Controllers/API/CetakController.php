...
class CetakController extends Controller
{
    ...
    function kehadiran_dosen(Request $request)
    {
        try {
            $periode = explode(' - ', $request->periode);
                ...
                if ($employee) {
                    ...
                    if (!isset($employeeData[$dateKey][$empCode])) {
                        $employeeData[$dateKey][$empCode] = [
                            ...
                            'unit_departement' => $department,
                            'tanggal' => $punchTime->format('Y-m-d'),
                            'jam_kehadiran' => $punchTime->format('Y-m-d H:i:s'),
                        ];
                    } else {
                        if ($punchTime->lessThan(Carbon::parse($employeeData[$dateKey][$empCode]['jam_kehadiran']))) {
                            $employeeData[$dateKey][$empCode]['jam_kehadiran'] = $punchTime->format('Y-m-d H:i:s');
                        }
                    }
                }
            }
